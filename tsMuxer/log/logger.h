//
// Created by zhangbin on 2020/2/23.
//

#ifndef TSMUXER_MAIN_LOGGER_H
#define TSMUXER_MAIN_LOGGER_H
//#pragma once
#include <string>
#include <fstream>
#include <sstream>
...
namespace AXMedia
{
    namespace logger
    {
        ...
        extern ConsoleLogger console_debug;
...
#define CLOG (AXMedia::logger::console_debug(AXMedia::logger::Level::Debug)<<"["<<__FUNCTION__<<"_"<<__FILE__<<"_"<< __LINE__<<"]")




#endif //TSMUXER_MAIN_LOGGER_H
